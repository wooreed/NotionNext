...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_magazine || 'hexo', // 锁定默认主题为hexo
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Reed', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || 'fucking life and fucked by life', // 作者简介
